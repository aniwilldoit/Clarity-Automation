# -*- coding: utf-8 -*-
"""
Created on Mon Nov 26 18:27:46 2018
...
for i in range(1,sheet.nrows):
    try :
        ...
        #resourceid search   
        resid=sheet.cell_value(i ,0).split()
        ...
        #Properties Tab
        text1=sheet.cell_value(i ,1).strip()
#        print (type(text4))
        print(i)
        driver.find_element_by_name("prusertext1").clear()
        driver.find_element_by_name("prusertext1").send_keys(text1)     #text4
        driver.find_element_by_xpath("/html/body/div/div[5]/div/button[1]").click()
        time.sleep(2)
        ws.cell(row=i+1, column=3).value = 'Costcenter Update Successful'
        wb.save(target)
...
#newMail.Subject = "Resource Updation sheet"
## newMail.Body = "I AM\nTHE BODY MESSAGE!"
#newMail.BodyFormat = 2 # olFormatHTML https://msdn.microsoft.com/en-us/library/office/aa219371(v=office.11).aspx
#newMail.HTMLBody = "<HTML><BODY>Please find attached file.</BODY></HTML>"
#newMail.To = "priyanka.d.das@capgemini.com"
##newMail.Cc= ""
